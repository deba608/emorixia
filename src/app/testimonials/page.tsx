...
export default function TestimonialsPage() {
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 flex flex-col gap-20">
      ...
      {/* Featured slider */}
      <div className="bg-muted/20 border border-border/10 rounded-[2.5rem] p-4 md:p-8">
      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {allReviews.map((rev, idx) => (
            <div
              key={idx}
              className="bg-card border border-border/40 rounded-3xl p-8 flex flex-col justify-between gap-6 shadow-sm hover:shadow-md hover:border-primary/20 transition-all duration-300"
            >
              {/* Stars */}
      ...
      <div className="bg-secondary/40 border border-primary/10 rounded-[2rem] p-8 md:p-12 text-center max-w-4xl mx-auto flex flex-col items-center gap-5">
        ...
        <a
          ...
          className="bg-primary hover:bg-primary-hover text-white px-6 py-3 rounded-full font-bold text-sm shadow-md transition-colors"
        >
